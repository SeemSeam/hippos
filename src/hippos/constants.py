...
INDEX_FILE = "hippos-index.json"
LEGACY_INDEX_FILE = "hippocampus-index.json"
VIZ_FILE = "hippos-viz.html"
LEGACY_VIZ_FILE = "hippocampus-viz.html"
FILE_MANIFEST_FILE = "file-manifest.json"
...
BUNDLE_STATE_FILE = "bundle-state.json"
