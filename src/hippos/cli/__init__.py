"""Click CLI entry point - hippos command group."""
...
def cli(ctx, config_path, output_dir, verbose, quiet):
    """Hippos - code repository indexing toolkit.

    Quick start:

    \b
      Full generation: hippos .
      Another repo: hippos /path/to/repo
      Incremental refresh: hippos update
      Force full refresh: hippos refresh .
      Manual steps: hippos init / sig-extract / tree / index / structure-prompt
      Inspect outputs: hippos overview
